...
&emsp;**Location:** 26th Floor, Bitexco Financial Tower, 02 Hai Trieu St, Ben Nghe Ward, District 1, HCMC
...
2. **Mastering Containerization with Docker** (Bao - Swinburne University)
	This presentation provided an in-depth look at Containerization, contrasting it with traditional Virtualization. The speaker demonstrated how Docker streamlines application packaging, dependency resolution, and ensures environment parity across development and production stages.

3. **Developing Advanced AI Apps with GraphRAG** (Speaker from Swinburne University)
	After covering standard RAG concepts, the speaker introduced GraphRAG as a powerful paradigm for context-heavy AI solutions. By leveraging Amazon Bedrock and Amazon Neptune, the presentation illustrated how knowledge graphs significantly improve the accuracy, traceability, and business value of GenAI responses.

4. **Detecting Cyber Attacks with WAF and ML** (Dai)
	This cybersecurity talk discussed the critical role of Web Application Firewalls and Network Intrusion Detection Systems. The core takeaway was how integrating Machine Learning models enables the detection of sophisticated, anomalous attack patterns that bypass traditional static rules.

5. **Career Path: From IT Helpdesk to Senior Sysadmin**
	An inspiring closing session about career growth within the IT industry. The speaker recounted his journey from basic support roles to mastering cloud technologies, sharing valuable group interview tips and long-term career development strategies for system administrators.
